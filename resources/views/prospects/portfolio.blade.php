...
@section('content')
		...
		<div class="row">
							<div class="col">
                              ...
                              <h2 class="card-title text-center">Academic Portfolio</h2>
                              ...
                              <div class="wizard-progress wizard-progress-lg">
                                 ...
                                 {!! Form::model( $prospect, ['method' => 'PUT', 'class' => 'form-horizontal form-bordered'  , 'action' =>['ProspectController@updateEdu', $prospect->id]])!!} 

                                    
                                    <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2">School</label>
                                    {!! Form::text('school_a', null, ['class' =>'form-control col-lg-6']) !!}
                                    </div>

                                    <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2">Degree</label>
                                    {!! Form::text('degree_a', null, ['class' =>'form-control col-lg-6']) !!}
                                    </div>

                                     <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2">Field of Study</label>
                                    {!! Form::text('field_a', null, ['class' =>'form-control col-lg-6']) !!}
                                    </div>
                                     <div class="form-group row">
                                      <label class="col-lg-3 control-label text-lg-right pt-2">Start Year</label>
                                     {!! Form::select('commence_id', $commences, null, ['class' =>'form-control col-lg-6']) !!}
                                    </div>

                                    <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2">End Year</label>
                                     {!! Form::select('graduation_id', $graduations, null, ['class' =>'form-control gutterx col-lg-6']) !!}
                                    </div>

                                    <div class="form-group row">
                                    <label class="col-lg-3 control-label text-lg-right pt-2">Grade</label>
                                    {!! Form::text('grade_a', null, ['class' =>'form-control col-lg-6']) !!}
                                    </div>
